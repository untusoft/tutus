...
<head>
    ...
    <title>Application Logon Screen</title>
...
<div id="msg-div"></div>
<div id="copyright">
	<div>Copyright (C) 2014 Untusoft <a href="javascript:void(0)" onClick="Ext.getCmp('winCopyright').show();">GPLv3</a> |:| v<?php print VERSION ?></div>
</body>
</html>