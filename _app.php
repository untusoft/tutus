...
//                'App.model.areas.PoolDropAreas',
				/**
				 * Load all the stores used by Untusoft
...
//                'App.ux.PatientEncounterCombo',
				 ...
				 * This is the Calendar Component that Untusoft uses.
				 */
				/*
...
//				'App.view.signature.SignatureWindow',
            ...
            (function(){
                ...
                if(isDevelopment || !isDevelopment){
                    say('Loading Application Classes (Development)');
                    ...
                    say('Loading Application Classes (Production)');
