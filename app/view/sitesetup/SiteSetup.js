							...
							me.welcome = Ext.create('Ext.Container',
								{
									...
									items:[
										{
											xtype:'panel',
											title:'Welcome to Untusoft Site Setup',
											...
											items:[
												{
													...
													height:120,
													padding:'5 10 0 10',
													html:' <p>Please allow 10-15 minutes to complete the installation process.</p>' + '<p>The Untusoft Site Setup will do most of the work for you in just a few clicks.</p>' + '<p>However, you must know how to do the following:</p>' + '<ul>' + '<li>Set permissions on folders & subfolders using an FTP client</li>' + '<li>Create a MySQL database using phpMyAdmin (or by asking your hosting provider)</li>' + '</ul>'
												},
												{
													xtype:'fieldset',
													...
													items:[
														me.licence = Ext.create('Ext.Container',
															...
															{
																boxLabel:'I agree to the Untusoft terms and conditions',
																name:'topping',
																margin:'5 0 0 0',
																inputValue:'1',
																scope:me,
												...
												items:[
													{
														...
														plugins:[
															{
																ptype:'helpicon',
																helpMsg:'Most Untusoft installations will support only one site.<br>' + 'If that is the case for you, leave Site ID on <span style="font-weight: bold;">"default"</span>.<br>' + 'Otherwise, use a Site ID short identifier with no spaces<br>' + 'or special characters other dashes. It is case-sensitive,<br>' + 'we suggest sticking to lower case letters for ease of use'
															}
														],
														listeners:{
															scope:me,
									...
									me.installationDetails = Ext.create('Ext.container.Container', {
										...
										tpl:new Ext.XTemplate(
											'<h2><span style="color: #008000;">Sweet!</span> Your New site is ready.</h2>' +
												...
												'</ul>' +
												'<p style="color: #008000;">Please take a few moment to answer the survey. We use this info to continue improve Untusoft user experience.</p>'
										)
									}),
										...
										items:[
											me.surveyFields = Ext.create('Ext.form.FieldSet', {
												...
												items:[
													...
													{
														xtype:'checkbox',
														fieldLabel:'First Time Using Untusoft?',
														name:'first_time',
														inputValue:'1'
													},
													{
			...
			Ext.data.JsonP.request(
				{
					...
					callback:function(data, success){
						succesMsg = '<h3>Sweet! Data successfully sent :-)</h3>' +
							'<p>Thanks for taking the time, to help us improve Untusoft<br>' +
						...
						failureMsg = '<h3>Oops! Unable to contact Untusoft server :-(</h3>' +
							'<p>No worries...<br>' +
