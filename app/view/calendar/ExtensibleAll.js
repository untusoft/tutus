...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    deleteButtonText: 'Delete',
    cancelButtonText: 'Cancel',
	patientLabelTex     : 'Patient',            // Untusoft
	categoryLabelTex    : 'Category',           // Untusoft
	facilityLabelTex    : 'Facility',           // Untusoft
	billingLabelTex     : 'Billing Facility',   // Untusoft
	statusLabelTex      : 'Status',             // Untusoft
	titleLabelText      : 'Notes',              // Untusoft
	datesLabelText      : 'When',               // Untusoft
	calendarLabelText   : 'Provider',           // Untusoft
...
/*
        {
			xtype     : 'patienlivetsearch',                                            // Untusoft
...
*/
        {
			...
			xtype     : 'mitos.calcategoriescombobox',                                  // Untusoft
...
/*
        {
			xtype     : 'activefacilitiescombo',                                  // Untusoft
        ...
        {
			xtype     : 'mitos.billingfacilitiescombo',                                 // Untusoft
...
*/
        {
			...
			xtype     : 'extensible.daterangefield',                                    // Untusoft
			itemId    : this.id + '-dates',
			name      : 'dates',
			anchor    : '95%',
			fieldLabel: this.datesLabelText
		},{
			xtype     : 'mitos.calstatuscombobox',                                      // Untusoft
...
*/
    ...
    show: function(o, animateTarget){
        ...
        if (o.data) {
	        ...
	        me.formPanel.getComponent(this.id + '-patient_search').hide();    //Untusoft
	        me.formPanel.getComponent(this.id + '-title').show();             //Untusoft
	        ...
	        me.formPanel.getComponent(this.id + '-patient_search').show();    //Untusoft
	        me.formPanel.getComponent(this.id + '-title').hide();             //Untusoft
...
Ext.define('Extensible.calendar.view.Month', {
    ...
    getTemplateEventData : function(evt){
		var M = Extensible.calendar.data.EventMappings,
			...
			status = evt[M.Status.name], // Untusoft
        ...
        data.Title = (!status || status.length == 0 ? '' : status) + // Untusoft
